...
File compression is the process of reducing the size of file or directories using command line tool like gzip with compression.

![alt filecompress](filecompress.png)
